...
public partial class DetallesDelPedidoAdmin : ContentPage
{
    ...
    public DetallesDelPedidoAdmin(Articulo articulo, int id, float tDinero, string cartelOferta, string cartelNovedad, string colorOferta, string colorNovedad)
	{
		InitializeComponent();
